...
push_mode=1
log_file=$CONTAINER_LOG_DIR/contrail-device-manager.log
log_level=$LOG_LEVEL
log_local=$LOG_LOCAL
...
[DEFAULTS]
log_file=$CONTAINER_LOG_DIR/contrail-fabric-ansible.log
log_level=$LOG_LEVEL
log_local=$LOG_LOCAL
collectors=$COLLECTOR_SERVERS
...
upgrade_old_logs "fabric-ansible"
upgrade_old_logs "device-manager"
