...
DPDK_ENABLE_VLAN_FWRD=${DPDK_ENABLE_VLAN_FWRD:-False}
...
CONFIG_API_ADMIN_PORT=${CONFIG_API_ADMIN_PORT:-8095}
...
CONFIG_API_WORKER_COUNT=${CONFIG_API_WORKER_COUNT:-1}
CONFIG_API_MAX_REQUESTS=${CONFIG_API_MAX_REQUESTS:-1024}
...
CASSANDRA_REAPER_ENABLED=${CASSANDRA_REAPER_ENABLED:-"false"}
CASSANDRA_REAPER_JMX_KEY=${CASSANDRA_REAPER_JMX_KEY:-"reaperJmxKey"}
CASSANDRA_REAPER_JMX_AUTH_USERNAME=${CASSANDRA_REAPER_JMX_AUTH_USERNAME:-"reaperUser"}
CASSANDRA_REAPER_JMX_AUTH_PASSWORD=${CASSANDRA_REAPER_JMX_AUTH_PASSWORD:-"reaperPass"}
CASSANDRA_REAPER_APP_PORT=${CASSANDRA_REAPER_APP_PORT:-8071}
CASSANDRA_REAPER_ADM_PORT=${CASSANDRA_REAPER_ADM_PORT:-8072}
...
RABBITMQ_HEARTBEAT_INTERVAL=${RABBITMQ_HEARTBEAT_INTERVAL:-60}
RABBITMQ_CLUSTER_PARTITION_HANDLING=${RABBITMQ_CLUSTER_PARTITION_HANDLING:-'autoheal'}
...
KEYSTONE_AUTH_INTERFACE=${KEYSTONE_AUTH_INTERFACE:-}

# Kubernetes
KUBEMANAGER_NODES=${KUBEMANAGER_NODES:-${CONFIG_NODES}}
KUBERNETES_CLUSTER_NAME=${KUBERNETES_CLUSTER_NAME:-'k8s'}
KUBERNETES_CNI_META_PLUGIN=${KUBERNETES_CNI_META_PLUGIN:-'multus'}
...
SANDESH_SERVER_KEYFILE=${SANDESH_SERVER_KEYFILE:-${SANDESH_KEYFILE}}
SANDESH_SERVER_CERTFILE=${SANDESH_SERVER_CERTFILE:-${SANDESH_CERTFILE}}
