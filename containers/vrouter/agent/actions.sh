...
function prepare_agent_config_vars {
    ...
    local HP_DIR allocated_pages_1GB allocated_pages_2MB
...
EOM
    ...
    # TODO refactor this for use params.sh file
    local variable
    ...
    PRIORITY_SCHEDULING IS_VLAN_ENABLED QOS_QUEUE_ID PRIORITY_TAGGING QOS_LOGICAL_QUEUES QOS_DEF_HW_QUEUE
